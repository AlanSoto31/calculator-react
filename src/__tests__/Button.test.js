...
describe("<Button/>", () => {
  ...
  beforeEach( () => {
    component = render(
    <Button name="x" clickHandler2={mockHandler} color="orange" wide={false}></Button>);
  })
    ...
    test("Changes its width value relay on wide value", () => {
      const component2 = render(<Button name="+" clickHandler2={mockHandler} color="orange" wide={true}></Button>);
      const button = component.getByText('x');
